defmodule ReportsGeneratorTest do
  ...
  describe "build_from_many" do
    ...
    test "when a file list is not provided, return an error" do
      response = ReportsGenerator.build_from_many("invalid value")

      expected_response = {:error, "Please provide a list of string"}
  ...
  describe "fetch_higher_cost/2" do
    ...
    test "when the option is 'foods', return the most consumed foods" do
      file_name = "report_test.csv"
